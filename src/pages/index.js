        ...
        tabs: [
            {
                ...
                content: <>
                    ...
                    <VideoSection content={{
                        video: require('../images/eConsult_optimised.mp4'),
                        linkedVideo: require('../images/eConsult.mp4'),
            ...
            },
            {
                ...
                content: <>
                    <VideoSection content={{
                        video: require('../images/innovation_optimised.mp4'),
                        linkedVideo: require('../images/innovation.mp4'),
